...
import 'package:prestige_valet_app/features/profile/presentation/widgets/deactivate_account_button.dart';
                  ...
                  body: SizedBox(
                    ...
                    child: Stack(
                      ...
                      children: [
                        ...
                        const Positioned(
                            bottom: 75, child: DeactivateAccountButton()),
                        const Positioned(
                            bottom: 10, child: LogoutButtonWidget()),
                      ],
                    ),
                  ),
                );
