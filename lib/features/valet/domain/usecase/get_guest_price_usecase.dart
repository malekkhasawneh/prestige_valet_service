...
class GetGuestPriceUseCase extends UseCase<double, GetGuestPriceUseCaseParams> {
  final ValetRepository repository;

  GetGuestPriceUseCase({required this.repository});

  @override
  Future<Either<Failures, double>> call(GetGuestPriceUseCaseParams params) async {
